...
(gtk_accel_path "<Actions>/terminal-window/close-tab" "<Primary><Shift>q")
...
(gtk_accel_path "<Actions>/terminal-window/zoom-in" "<Primary><Shift>asterisk")
...
(gtk_accel_path "<Actions>/terminal-window/zoom-reset" "<Primary><Shift>n")
...
(gtk_accel_path "<Actions>/terminal-window/undo-close-tab" "<Primary><Shift>u")
(gtk_accel_path "<Actions>/terminal-window/open-folder" "<Primary><Shift>t")
...
(gtk_accel_path "<Actions>/terminal-window/move-tab-left" "Escape")
...
(gtk_accel_path "<Actions>/terminal-window/zoom-out" "<Primary><Shift>underscore")
