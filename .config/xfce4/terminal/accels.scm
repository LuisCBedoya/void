...
(gtk_accel_path "<Actions>/terminal-window/new-tab" "<Primary><Shift>Return")
...
(gtk_accel_path "<Actions>/terminal-widget/shift-pagedown" "<Primary><Shift>j")
...
(gtk_accel_path "<Actions>/terminal-window/open-folder" "<Primary><Shift>p")
...
(gtk_accel_path "<Actions>/terminal-widget/shift-pageup" "<Primary><Shift>k")
